...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VendAI — Transforme conversas em vendas" },
      {
        name: "description",
        content:
          "IA de vendas para WhatsApp e Instagram: analise conversas, classifique leads e receba respostas prontas para vender.",
      },
      { name: "author", content: "VendAI" },
